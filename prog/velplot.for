...
c----------------------------------------------------------------------c
	...
	include 'velplot.h'
	character*(*) version
	parameter(version='(version 3.0 25-Oct-93)')
	...
	real ary(maxbuf),vlsr(maxdim),v(maxdim*maxdim),pi
c
